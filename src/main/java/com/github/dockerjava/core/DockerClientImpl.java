...
public class DockerClientImpl implements Closeable, AutoCloseable, DockerClient {
    ...
    @Override
    public CheckpointContainerCmd checkpointContainerCmd(String containerId) {
        return new CheckpointContainerCmdImpl(getDockerCmdExecFactory().createCheckpointContainerCmdExec(), containerId);
    }

    @Override
    public RestoreContainerCmd restoreContainerCmd(String containerId) {
        return new RestoreContainerCmdImpl(getDockerCmdExecFactory().createRestoreContainerCmdExec(), containerId);
    }
